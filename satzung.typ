...
+ Fördermitglied kann jede natürliche oder juristische Person, Handelsgesellschaften, nicht rechtsfähige Vereine sowie Anstalten und Körperschaften des öffentlichen Rechts werden. Fördermitglieder haben kein Stimm- und Rederecht auf Mitgliederversammlungen.
...
+ Abstimmungen erfolgen auf Antrag eines stimmberechtigten Mitglieds geheim. Wahlen erfolgen immer geheim. Über die Beschlüsse der Mitgliederversammlung ist ein Protokoll anzufertigen, das vom Versammlungsleiter und dem Protokollführer zu unterzeichnen ist; das Protokoll ist allen Mitgliedern zugänglich zu machen und auf der nächsten Mitgliederversammlung genehmigen zu lassen.
+ Die Versammlung wird von einem Mitglied des Vorstands geleitet, welches zu Beginn der Versammlung vom anwesenden Vorstand bestimmt wird. Sind alle Vorstandsmitglieder verhindert, bestimmt die Versammlung die Versammlungsleitung. Die aktuelle Versammlungsleitung kann die Aufgabe auf eine andere Person übertragen. Die Versammlungsleitung kann zur Durchführung der Versammlung weitere Personen zur Unterstützung hinzuziehen.
...
+ Der Vorstand kann Beiräte einrichten und auflösen, die für den Verein beratend und unterstützend tätig werden; in die Beiräte können auch Nicht-Mitglieder berufen werden.
...
+ Die Mitgliederversammlung wählt jeweils für die Dauer von zwei Geschäftsjahren mindestens zwei Rechnungsprüfer, die nicht Mitglieder des Vorstandes sind. Eine Wiederwahl ist zulässig.
...
+ Der Vorstand ist befugt, Änderungen und Ergänzungen an der Satzung vorzunehmen, um Auflagen des Registergerichts oder einer Behörde zu entsprechen. Über Änderungen und Ergänzungen sind die Mitglieder unverzüglich in Textform zu informieren.
